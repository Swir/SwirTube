...
<title id="title">SwirTube product progress</title><desc id="desc">Product roadmap progress is not available because this repository has no canonical measurable roadmap.</desc>
<defs><linearGradient id="bg" x1="0" y1="0" x2="1" y2="1"><stop stop-color="#02050A"/><stop offset="1" stop-color="#07111C"/></linearGradient><pattern id="grid" width="26" height="26" patternUnits="userSpaceOnUse"><path d="M26 0H0V26" fill="none" stroke="#62E5FF" stroke-opacity=".06"/></pattern></defs>
...
<text x="50" y="82" fill="#F4FAFF" font-family="Segoe UI,Arial,sans-serif" font-size="31" font-weight="800">SWIRTUBE</text>
...
<text x="50" y="169" fill="#8DA8B8" font-family="Segoe UI,Arial,sans-serif" font-size="13">Historical release labels are intentionally not converted into product completion.</text>
</svg>
'''

MINI = '''<svg xmlns="http://www.w3.org/2000/svg" width="900" height="72" viewBox="0 0 900 72" role="img" aria-labelledby="title desc">
<title id="title">SwirTube roadmap progress</title><desc id="desc">Roadmap progress is N/A because no canonical measurable roadmap exists.</desc>
